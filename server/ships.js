...
export const SHIP_TYPES = {
  ...
  linkor: {
    ...
    move: 90,
    fishing: 0,
    portBonus: 2, // двойной урон по вражескому порту — главный осадный корабль
    broadside: true,
    desc: 'Король моря. Бьёт по порту вдвойне (130!) и даёт залп 💥 по всем врагам. Медленный, но почти непотопляемый.'
  }
};
