...
export const SHIP_TYPES = {
  barkas: {
    ...
    fireRange: 70,
    move: 140,
    fishing: 8, // золота КАЖДЫЙ ХОД, пока стоит в рыбном месте (без траты действия)
    desc: 'Стоит в рыбном месте — каждый ход сам приносит 8 золота, действие на это не тратится. Почти не вооружён.'
  },
  shkhuna: {
    name: 'Шхуна',
    icon: '🛥',
