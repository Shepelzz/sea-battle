...
export const DEBUG_GOLD_LOG = false;
...
export const RT = {
  ...
  INCOME_MS: 8000,          // доход порта раз в столько мс (вместо «в начале хода»)
  FISH_MS: 8000,            // пассивная рыбалка раз в столько мс
...
export const RT_OUTPOST_MS = 8000;      // реалтайм: период дохода/ремонта/выстрела форта
