...
// 🐞 Дебаг экономики: каждое НАЧИСЛЕНИЕ золота пишется в журнал партии — кому, сколько и за что
// (доход порта, рыбалка, аванпост, награда за пирата, лут с обломков, дань, клад).
// Показывает доходы ВСЕХ игроков всем (туман не скрывает) — только для локальной отладки баланса.
export const DEBUG_GOLD_LOG = true;
