...
export const OUTPOST_LEVELS = [
  { name: 'Аванпост', icon: '⛺', price: 150, hp: 120, income: 3,
    desc: 'дозор: снимает туман вокруг острова + небольшой доход' },
  { name: 'Фактория', icon: '🏪', price: 250, hp: 180, income: 8, heal: 0.03,
    desc: 'доход больше + чинит твои корабли рядом (≈3% прочности)' },
  { name: 'Форт', icon: '🏰', price: 400, hp: 260, income: 12, heal: 0.03, gun: 15,
    desc: 'доход ещё больше + береговая пушка бьёт врагов и пиратов рядом' },
];
