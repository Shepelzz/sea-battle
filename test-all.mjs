...
const tests = ['test-config.mjs', 'test-broadside.mjs', 'test-pirates.mjs', 'test-balance2.mjs', 'test-bot.mjs', 'test-multimove.mjs', 'test-cheats.mjs', 'test-shipyard.mjs', 'test-repair.mjs', 'test-modes.mjs'];
let failed = 0;
